...
const Home: NextPage = () => {
  ...
  return (
    <div className="bg-[#091B18] min-h-screen flex flex-col">
      ...
      <footer className="border-t border-emerald-500/20 flex items-center text-white justify-self-start p-5">
        <img
          className="h-10 w-10 filter hue-rotate-60 opacity-40 rounded-full hover:opacity-100 hover:hue-rotate-0 hover:filter-none"
          src="https://user-images.githubusercontent.com/87669361/205507193-155e23c6-d7e7-4d7e-bc0f-793c42fa9c36.jpg" alt="" />
        <div className="flex flex-col items-center md:pl-80">
          <div className="flex">
            <h1 className="text-sm text-emerald-900 pl-5">
